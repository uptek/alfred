...
New Assets tab in the popup shows every script and stylesheet a page loads, with size, load time, and performance signals — so you can see exactly what's weighing a page down.
