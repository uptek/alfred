...
export function ThemeInspectorSetting() {
  ...
  return (
    <s-section heading="Theme inspector">
      <s-paragraph>
        Controls how Alfred manages the theme inspector in the customizer. Choose to disable it automatically, remember
        and restore your last state, or leave it unchanged.
      </s-paragraph>
