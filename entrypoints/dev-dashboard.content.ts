...
function injectToggle(currentMode: ThemeMode) {
  ...
  pill.style.cssText =
    'position:absolute;border-radius:6px;transition:left 0.25s cubic-bezier(0.4,0,0.2,1),width 0.25s cubic-bezier(0.4,0,0.2,1);pointer-events:none;top:2px;bottom:2px;z-index:0;';
