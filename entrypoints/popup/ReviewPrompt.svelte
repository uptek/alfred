    ...
    <div class="prompt__stars" onmouseleave={() => (hovered = 0)}>
      {#each [1, 2, 3, 4, 5] as star}
        ...
        <button
          ...
          class="prompt__star">
          <svg width="16" height="16" viewBox="0 0 24 24" fill={star <= hovered ? '#FBBF24' : '#E0E0E0'} class="prompt__svg">
    ...
    <div class="prompt__stars" onmouseleave={() => (hovered = 0)}>
      {#each [1, 2, 3, 4, 5] as star}
        ...
        <button
          ...
          aria-label="Rate {star} star{star > 1 ? 's' : ''}"
          class="prompt__star">
          <svg width="30" height="30" viewBox="0 0 24 24" fill={star <= hovered ? '#F59E0B' : '#D1D5DB'} class="prompt__svg">
